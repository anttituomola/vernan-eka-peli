...
const ColoringBook: React.FC = () => {
  ...
  const colors = [
    ...
    { id: '2', color: '#4ECDC4', name: 'Blue' },
    { id: '3', color: '#95E1A3', name: 'Green' },
    { id: '4', color: '#FFE66D', name: 'Yellow' },
    { id: '5', color: '#FF8C42', name: 'Orange' },
    { id: '6', color: '#B8B8FF', name: 'Purple' },
    { id: '7', color: '#FF9EC7', name: 'Pink' }
  ];
  ...
  const coloringScenes = {
    kite: {
      name: 'Flying a Kite',
      areas: [
        { id: 'kite-body', number: 1, path: 'M100,50 L150,50 L175,100 L125,125 L75,100 Z' },
        { id: 'kite-tail', number: 2, path: 'M125,125 Q130,140 125,155 Q120,170 125,185' },
        { id: 'child-head', number: 3, path: 'M50,200 Q70,180 90,200 Q70,220 50,200' },
        { id: 'child-body', number: 4, path: 'M60,220 L80,220 L85,280 L55,280 Z' },
        { id: 'ground', number: 5, path: 'M0,300 L300,300 L300,350 L0,350 Z' },
        { id: 'sun', number: 6, path: 'M250,30 Q270,10 290,30 Q270,50 250,30' },
        { id: 'cloud1', number: 7, path: 'M30,40 Q50,20 70,40 Q90,30 110,50 Q80,70 50,60 Q20,50 30,40' }
      ]
    },
    house: {
      name: 'Pretty House',
      areas: [
        { id: 'roof', number: 1, path: 'M50,100 L150,50 L250,100 L200,100 L100,100 Z' },
        { id: 'walls', number: 2, path: 'M100,100 L200,100 L200,200 L100,200 Z' },
        { id: 'door', number: 3, path: 'M130,150 L170,150 L170,200 L130,200 Z' },
        { id: 'window1', number: 4, path: 'M110,120 L130,120 L130,140 L110,140 Z' },
        { id: 'window2', number: 4, path: 'M170,120 L190,120 L190,140 L170,140 Z' },
        { id: 'tree', number: 5, path: 'M260,150 Q280,130 300,150 Q280,170 260,150' },
    ...
    car: {
      name: 'Fun Car',
      areas: [
        { id: 'car-body', number: 1, path: 'M50,150 L250,150 L250,200 L50,200 Z' },
        { id: 'car-top', number: 2, path: 'M100,100 L200,100 L200,150 L100,150 Z' },
        { id: 'wheel1', number: 3, path: 'M80,200 Q100,180 120,200 Q100,220 80,200' },
        { id: 'wheel2', number: 3, path: 'M180,200 Q200,180 220,200 Q200,220 180,200' },
        { id: 'window', number: 4, path: 'M110,110 L190,110 L190,140 L110,140 Z' },
  ...
  const currentScene = coloringScenes[selectedScene as keyof typeof coloringScenes];
        ...
        <div className="flex gap-6 w-full max-w-7xl">
          ...
          <div className="flex-1 bg-white rounded-kid-lg p-6 border-4 border-gray-300">
            ...
            <div className="flex justify-center">
              <svg width="350" height="300" viewBox="0 0 350 300" className="border-2 border-gray-300 rounded-kid">
                {currentScene.areas.map((area) => (
                  <g key={area.id}>
                    ...
                    {/* Number overlay */}
                    <text
                      x={area.path.includes('M') ? area.path.split('M')[1].split(',')[0] : 0}
                      y={area.path.includes('M') ? area.path.split(',')[1].split(' ')[0] : 0}
                      textAnchor="middle"
          ...
          <div className="flex-shrink-0 flex flex-col gap-4">
            ...
            <div className="bg-white/90 rounded-kid-lg p-4 max-w-48">
              ...
              <div className="text-sm text-gray-700 space-y-2">
                <div>1️⃣ Pick a color</div>
                <div>2️⃣ Click on areas with the same number</div>
                <div>3️⃣ Have fun coloring!</div>
              </div>
            </div>
          </div>
        </div>
