...
const DetectiveGame: React.FC = () => {
  ...
  const detectiveLevels: DetectiveLevel[] = [
    {
      ...
      decoyItems: [
        { id: 'book', name: 'Book', icon: '📖', position: { x: 150, y: 200 }, size: { width: 30, height: 20 } },
        { id: 'ball', name: 'Ball', icon: '⚽', position: { x: 300, y: 250 }, size: { width: 25, height: 25 } }
      ]
    },
    {
      id: 2,
      ...
      decoyItems: [
        { id: 'cup', name: 'Cup', icon: '☕', position: { x: 200, y: 120 }, size: { width: 25, height: 30 } },
        { id: 'spoon', name: 'Spoon', icon: '🥄', position: { x: 100, y: 180 }, size: { width: 20, height: 30 } }
      ]
    },
    {
      id: 3,
      ...
      decoyItems: [
        { id: 'flower', name: 'Flower', icon: '🌸', position: { x: 150, y: 200 }, size: { width: 25, height: 30 } },
        { id: 'bee', name: 'Bee', icon: '🐝', position: { x: 350, y: 160 }, size: { width: 25, height: 20 } }
      ]
    }
  ];
  ...
  const renderBackground = (scene: string) => {
    const backgrounds = {
      bedroom: (
        <g>
          ...
          {/* Window */}
          <rect x="300" y="50" width="80" height="60" fill="#87CEEB" stroke="#654321" strokeWidth="3" />
          <line x1="340" y1="50" x2="340" y2="110" stroke="#654321" strokeWidth="2" />
          
          {/* Dresser */}
          <rect x="350" y="180" width="100" height="80" fill="#8B4513" />
          <rect x="360" y="190" width="35" height="25" fill="#654321" stroke="#333" strokeWidth="1" />
          <rect x="405" y="190" width="35" height="25" fill="#654321" stroke="#333" strokeWidth="1" />
      ...
      kitchen: (
        <g>
          ...
          {/* Window */}
          <rect x="50" y="40" width="70" height="50" fill="#87CEEB" stroke="#654321" strokeWidth="3" />
          
          {/* Cabinets */}
          <rect x="0" y="50" width="400" height="100" fill="#8B4513" />
          <rect x="10" y="60" width="60" height="80" fill="#654321" stroke="#333" strokeWidth="1" />
          <rect x="80" y="60" width="60" height="80" fill="#654321" stroke="#333" strokeWidth="1" />
        </g>
      ),
      garden: (
        <g>
    ...
    return backgrounds[scene as keyof typeof backgrounds] || backgrounds.bedroom;
  };
      ...
      <div className="flex flex-col items-center h-full">
        ...
        <div className="bg-white rounded-kid-lg p-4 mb-4 border-4 border-gray-300">
          ...
          <div className="text-center">
            <div className="text-6xl mb-2">{currentLevelData.hiddenItem.icon}</div>
            ...
            >
              ...
              {foundObject && (
                <g>
                  ...
                  />
                  <text
                    x={currentLevelData.hiddenItem.position.x + currentLevelData.hiddenItem.size.width / 2}
                    y={currentLevelData.hiddenItem.position.y + currentLevelData.hiddenItem.size.height / 2 + 8}
                    textAnchor="middle"
                    fontSize="20"
                  >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white/90 rounded-kid-lg p-4 max-w-48">
              ...
              <div className="text-sm text-gray-700 space-y-2">
                <div>👀 Look at the picture above</div>
                <div>🔍 Find that object in the scene</div>
                <div>👆 Click on it when you see it</div>
                <div>🎯 Red dots show where you clicked</div>
              </div>
            </div>
            ...
            <div className="bg-yellow-200 rounded-kid-lg p-4 max-w-48">
              ...
              <div className="text-sm text-gray-700 text-center">
                {currentLevel === 1 && "Look near the dresser!"}
                {currentLevel === 2 && "Check the counter area!"}
                {currentLevel === 3 && "Look up in the sky!"}
              </div>
            </div>
          </div>
        </div>
